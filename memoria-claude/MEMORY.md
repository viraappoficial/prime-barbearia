...
- [Caixa + Fiado plan](project_caixa-fiado-plan.md) — future cash-register module (cofre, sangria, fechamento) + A Prazo/Fiado receivables — full design agreed 2026-08-01, not yet implemented. Invoice ("fatura") MUST use full Prime brand identity, never generic.
