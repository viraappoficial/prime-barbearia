...
- [Caixa + Fiado plan](project_caixa-fiado-plan.md) — Fases 1 (forma de pagamento/split) e 2 (Caixa: cofre/sangria/fechamento) DONE and in production as of 2026-08-05. Fase 3 (A Prazo/Fiado) still pending — invoice ("fatura") MUST use full Prime brand identity when built, never generic.
